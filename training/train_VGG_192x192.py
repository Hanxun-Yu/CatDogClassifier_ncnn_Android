...
#train_dataset = torchvision.datasets.ImageFolder(root='\\\\10.1.1.63\\i\\DMS\\DOAData\\train', transform=transform)
train_dataset = torchvision.datasets.ImageFolder(root='../210w/train', transform=transform)
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=BARCH_SIZE, shuffle=True)

#validation_dataset = torchvision.datasets.ImageFolder(root='\\\\10.1.1.63\\i\\DMS\\DOAData\\test', transform=transform)
validation_dataset = torchvision.datasets.ImageFolder(root='../210w/test', transform=transform)
...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        for i, (images, labels) in enumerate(train_loader):
            ...
            sum_loss += loss.item()
            if i % 100 == 0:
                print("EPOCH:", epoch, " Iteration :", i," Ave loss:", sum_loss / 100, " lr:",LR)
                sum_loss = 0.0
